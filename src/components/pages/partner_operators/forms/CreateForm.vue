...
export default {
    ...
    methods: {
        ...
        async create() {
            await partnerOperatorRepository.create(this.form)
            .then( reponse => {
                // setTimeout( () => {
                    this.closeDialog();
                // }, 1000);
        ...
        async update() {
            await partnerOperatorRepository.update(this.form, this.formId)
            .then( reponse => {
                // setTimeout( () => {
                    this.closeDialog();
                // }, 1000);
        ...
        async checkEditView() {
            ...
            if (this.formId) {
                let {data} = await partnerOperatorRepository.getUsingId(this.formId);
