                ...
                <v-card>
                    ...
                    >
                        <template v-slot:item.action="{ item }">
                            <create-dialog :button="editDialog.button" title="Edit Technician" :form="item" :formId="item.id"></create-dialog>
                        </template>
                    </v-data-table>
                </v-card>  
            </v-col>
...
export default {
    ...
    methods: {
        async getData(){
            ...
            await technicianRepository.get({limit: limit, page: this.options.page})
            .then(response => {
