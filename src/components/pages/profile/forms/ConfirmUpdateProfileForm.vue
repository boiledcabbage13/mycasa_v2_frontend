<template>
    <v-card class="card-custom">
        ...
        <v-card-text>
            ...
            >
                <v-row>
                    <v-col cols="12"><span class="sub-header --size --black">Confirm Changes?</span></v-col>
                    <v-divider></v-divider>
                </v-row>
                <v-row>
                    <v-col
                    ...
                    >
                        <v-text-field v-model="form.currentPassword" label="Password" type="password" required :rules="requiredRules"></v-text-field>
                    </v-col>
                </v-row>
            </v-form>
        </v-card-text>
