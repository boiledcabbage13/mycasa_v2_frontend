  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/settings', name: 'settings', component: () => import('./components/pages/settings/SettingsPage.vue'), 
          children: [
            { path: '/ads-management', name: 'ads-management', component: () => import('./components/pages/settings/ads_management/AdsManagement.vue')},
          ]
        },
